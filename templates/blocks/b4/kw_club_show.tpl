                    ...
                    <li class="vm w1 text-center">
                        <{if $iskwDeviceAdmin}>
                            <{if $data.class_ischecked!=1}>
                                <a href="<{$xoops_url}>/modules/Kw_device/club.php?op=class_enable&class_id=<{$data.class_id}>" class="btn btn-sm btn-success" data-toggle="tooltip" data-placement="bottom" title="<{$smarty.const._MB_KWCLUB_CLASS_ENABLE_DESC}>"><{$smarty.const._MB_KWCLUB_CLASS_ENABLE}></a>
                            <{else}>
                                <a href="<{$xoops_url}>/modules/Kw_device/club.php?op=class_unable&class_id=<{$data.class_id}>" class="btn btn-sm btn-danger" data-toggle="tooltip" data-placement="bottom" title="<{$smarty.const._MB_KWCLUB_CLASS_UNABLE_DESC}>"><{$smarty.const._MB_KWCLUB_CLASS_UNABLE}></a>
                            <{/if}>
                            <a href="<{$xoops_url}>/modules/Kw_device/club.php?op=class_blank&class_id=<{$data.class_id}>" class="btn btn-sm btn-secondary" data-toggle="tooltip" data-placement="bottom" title="<{$smarty.const._MB_KWCLUB_CLASS_BLANK_DESC}>"><{$smarty.const._MB_KWCLUB_CLASS_BLANK}></a>
                        <{/if}>

                        <{if $iskwDeviceAdmin || $block.uid == $data.class_uid}>
                            <a href="<{$xoops_url}>/modules/Kw_device/club.php?class_id=<{$data.class_id}>" class="btn btn-sm btn-warning" <{if !$block.can_operate}>data-toggle="tooltip" data-placement="bottom" title="<{$smarty.const._MB_KWCLUB_OVER_END_TIME}>" disabled<{/if}>><{$smarty.const._TAD_EDIT}></a>
                        ...
                        <{else}>
                            ...
                            <{elseif $data.class_regnum >= $data.class_member}>
                                <a href="<{$xoops_url}>/modules/Kw_device/index.php?op=reg_form&class_id=<{$data.class_id}>&is_full=1" class="btn btn-warning btn-sm"><i class="fa fa-user-plus" aria-hidden="true"></i>
                                    <{$smarty.const._MB_KWCLUB_SIGNUP_TO_MAKE_UP}></a>
                            <{elseif $block.chk_time}>
                                <a href="<{$xoops_url}>/modules/Kw_device/index.php?op=reg_form&class_id=<{$data.class_id}>" class="btn btn-primary btn-sm"><i class="fa fa-user-plus" aria-hidden="true"></i>
