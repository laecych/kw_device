...
<!-- <select name="review" id="review" onChange="location.href='index.php?review=' + $('#review').val() ;">
    ...
    <{if $all_equ_content}>
        <div class="vtable" style="margin: 10px auto 20px;">
            ...
            <div class="vtable" style="margin: 10px auto 20px;">
                <ul id="tr_<{$data.equ_id}>">
                    ...
                    <li class="vm w1"><{$data.equ_sort}>
                     ...
                     <!--設備年度 編號-->
                     <li class="vm w1"><{$data.equ_year}> / <{$data.equ_code}></li>
            ...
            <div class="row">
                <div class="col-md-2 alert alert-info"><{$smarty.const._MD_KWDEVICE_EQU_NOTE}>：</div>
                 <div class="col-md-8 alert alert-info"><{$data.equ_note}></div>
                 <div class="col-md-2 alert alert-info" >
                    <!--設備管理-->
                    <{if $iskwDeviceAdmin || $uid == $data.config_uid}>
                        <a href="index.php?op=kw_device_equ_form&equ_id=<{$data.equ_id}>" class="btn btn-sm btn-warning">
                        <{$smarty.const._TAD_EDIT}></a>
                        <{if $data.equ_available == $data.equ_number}><!--無借用可刪-->
                        <a href="javascript:delete_equ_func(<{$data.equ_id}>);" class="btn btn-sm btn-danger">
                        <{$smarty.const._TAD_DEL}></a>
                        <{/if}>
                    <{/if}>
                 </div>
